...
//     ui.verticalLayout_Tab->addWidget(&chartPair, 0);
...
//     ui.verticalLayout_Tab->addWidget(&candleChart, 0);
...
//     qCDebug(pairTraderGuiLog(), "--->>>>> symbol = %s, id = %ld, price = %f, type = %d", _symbol.toLocal8Bit().data(), _pTickPrice.getId(), _pTickPrice.getPrice(), _pTickPrice.getTickType());
