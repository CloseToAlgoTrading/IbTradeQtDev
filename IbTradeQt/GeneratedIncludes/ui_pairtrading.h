...
public:
    ...
    void setupUi(QWidget *PairTrading)
    {
        if (PairTrading->objectName().isEmpty())
            PairTrading->setObjectName(QString::fromUtf8("PairTrading"));
        ...
        pushButtonAddPair->setObjectName(QString::fromUtf8("pushButtonAddPair"));
        ...
        pushButtonBuyMkt->setObjectName(QString::fromUtf8("pushButtonBuyMkt"));
        pushButtonBuyMkt->setGeometry(QRect(20, 70, 75, 23));
        lineEditOrderSymbol = new QLineEdit(tab_3);
        lineEditOrderSymbol->setObjectName(QString::fromUtf8("lineEditOrderSymbol"));
        ...
        radioButtonBuy->setObjectName(QString::fromUtf8("radioButtonBuy"));
        ...
        pushButtonSellMkt->setObjectName(QString::fromUtf8("pushButtonSellMkt"));
        ...
        groupBoxPrice->setObjectName(QString::fromUtf8("groupBoxPrice"));
